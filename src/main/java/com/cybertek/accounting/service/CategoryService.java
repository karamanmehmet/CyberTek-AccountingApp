...
public interface CategoryService {
    ...
    List<CategoryDto> findAllByStatus(boolean enabled);
    ...
    void delete(long id) throws CategoryNotFoundException, CategoryHasProductException, CompanyNotFoundException;
